<x-layout.layout-admin>
    ...
    <div class="flex items-center justify-between w-full px-10 py-8 text-2xl">
        ...
        <button data-modal-target="tambahkantor"
            ...
            <i class="items-center ri-add-circle-line"><span class="px-2 text-center">Tambah Kantor</span></i>
        </button>
    </div>
    <hr class="border-t-2 border-gray-200">
    <div class="px-5 py-8">
        <table class="w-full text-base text-left text-center text-black border-[1px]  border-[#242947]  bg-gray-100 rtl:text-right rounded-b-lg">
            <thead class="text-base uppercase bg-gray-100 border-[1px] border-t-0  border-[#242947] ">
                <tr>
            ...
            <tbody>
                @foreach ($data as $kantor)
                    <tr>
                        ...
                        <td class="p-3 border-[#242947] border-[1px] border-t-0">
                        ...
                        <td class="px-3 py-2 border-[#242947] border-[1px] ">
                            ...
                            data-modal-toggle="editkantor{{ $kantor->id }}" class="text-white hover:bg-yellow-300 hover:text-gray-800 bg-yellow-400 px-2.5 rounded-lg py-1 text-center text-xl font-medium mr-3">
                            <i class="ri-edit-2-line"></i>
                            <button data-modal-target="deletekantor{{ $kantor->id }}"
                                data-modal-toggle="deletekantor{{ $kantor->id }}" class="text-white hover:bg-red-400 hover:text-gray-800 bg-red-500 px-2 rounded-lg py-1.5 text-center text-xl font-medium">
