<x-layout.layout-admin>
    ...
    <div class="flex items-center justify-between w-full px-10 py-8 text-2xl">
        ...
        <div class="p-4">
            <form class="flex items-center max-w-md mx-auto space-x-4" action="{{ route('dashboard.gaji.input.search',$karyawan->id) }}" method="GET">
                @csrf
    ...
    <div class="p-5 capitalize">
        ...
        <form action="{{route('dashboard.post.gaji', $karyawan->id)}}" method="POST" >
            ...
            <div class="relative p-5 overflow-x-auto border border-gray-200 shadow-md rounded-xl">
                <table class="w-full mb-5 text-sm text-center text-black table-auto rtl:text-right">
                    <tbody class="text-start">
                        <tr class="py-2">
                            ...
                            <td>:</td>
                            <td class="">
                                <input class="px-0 py-0 text-sm border-none" type="text" name="Periode"
                        ...
                        <tr class="py-2">
                            ...
                            <td>:</td>
                            <td class="">
                                <input class="px-0 py-0 text-sm border-none" type="text" name="MetodePembayaran"
                                    value="Transfer" id="">
                            </td>
                        </tr>
                    </tbody>
                    ...
                    <tbody id="tabelBody1">
                        <tr class="text-start">
                            <td class=" border-[#242947] border-[1px]">
                                <input class="w-full h-12 px-0 px-3 py-0 text-sm bg-blue-100 border-none" type="text" name="ShiftPeriode"
                                    value="Total Shift ({{ $tanggalMulai .' - '. $tanggalSelesai }})" id="" readonly>
                            </td>
                            <td class="border-[#242947] border-[1px]">
                                <input class="w-full h-12 px-0 px-3 py-0 text-sm text-right bg-blue-100 border-none" type="text" name="ShiftTotal"
                                    value="{{ $jumlahHariTanpaMinggu -  $jumlahTanggalLibur }}" id="" readonly>
                            </td>
                        </tr>
                        <tr class="text-start">
                            <td class=" border-[#242947] border-[1px]">
                                <input class="w-full h-12 px-0 px-3 py-0 text-sm bg-blue-100 border-none" type="text" name="gajiHeaderName1"
                                    value="Terlambat" id="">
                            </td>
                            <td class="border-[#242947] border-[1px]">
                                <input class="w-full h-12 px-0 px-3 py-0 text-sm text-right bg-blue-100 border-none" type="text" name="gajiHeaderValue1"
                                    value="{{ $totalTelat }}" id="" readonly>
                            </td>
                        </tr>
                        <tr class="text-start">
                            <td class=" border-[#242947] border-[1px]">
                                <input class="w-full h-12 px-0 px-3 py-0 text-sm bg-blue-100 border-none" type="text" name="gajiHeaderName2"
                                    value="Ijin Pulang Awal" id="">
                            </td>
                            <td class="border-[#242947] border-[1px]">
                                <input class="w-full h-12 px-0 px-3 py-0 text-sm text-right bg-blue-100 border-none" type="text" name="gajiHeaderValue2"
                                    value="{{ $totalPulangCepat }}" id="" readonly>
                            </td>
                        </tr>
                        <tr class="text-start">
                            <td class=" border-[#242947] border-[1px]">
                                <input class="w-full h-12 px-0 px-3 py-0 text-sm bg-blue-100 border-none" type="text" name="gajiHeaderName3"
                                    value="Tidak Hadir" id="">
                            </td>
                            <td class="border-[#242947] border-[1px]">
                                <input class="w-full h-12 px-0 px-3 py-0 text-sm text-right bg-blue-100 border-none" type="text" name="gajiHeaderValue3"
                                    value="{{ $totaltidakmasuk + $totalIzin }}"readonly>
                            </td>
                        </tr>
                        <tr class="text-start">
                            <td class=" border-[#242947] border-[1px]">
                                <input class="w-full h-12 px-0 px-3 py-0 text-sm bg-blue-100 border-none" type="text" name="gajiHeaderName4"
                                    value="Total Hadir Disiplin" >
                            </td>
                            <td class="border-[#242947] border-[1px]">
                                <input class="w-full h-12 px-0 px-3 py-0 text-sm text-right bg-blue-100 border-none" type="text" name="gajiHeaderValue4"
                                    value="{{ $totalmasuk - $totalTelat - $totalPulangCepat - $absensiLemburTotal    }}" id="" readonly>
                            </td>
                        </tr>
                        <tr class="text-start">
                            <td class=" border-[#242947] border-[1px]">
                                <input class="w-full h-12 px-0 px-3 py-0 text-sm bg-blue-100 border-none" type="text" name="gajiHeaderName5"
                                    value="Total Lembur Minggu" >
                            </td>
                            <td class="border-[#242947] border-[1px]">
                                <input class="w-full h-12 px-0 px-3 py-0 text-sm text-right bg-blue-100 border-none" type="text" name="gajiHeaderValue5"
                                    value="{{ $absensiLemburTotal  }}" readonly>
                            </td>
                        </tr>
                        <tr class="text-start">
                            <td class=" border-[#242947] border-[1px]">
                                <input class="w-full h-12 px-0 px-3 py-0 text-sm bg-blue-100 border-none" type="text" name="gajiHeaderName6"
                                    value="Total Kehadiran" id="">
                            </td>
                            <td class="border-[#242947] border-[1px]">
                                <input class="w-full h-12 px-0 px-3 py-0 text-sm text-right bg-blue-100 border-none" type="text" name="gajiHeaderValue6"
                ...
                <table class="w-full text-sm text-black bg-blue-100 rounded-b-lg table-auto text-start rtl:text-right">
                    <tbody id="tabelBody2">
                            ...
                            @if ($default->status == 1)
                                <tr class="border-[#242947] border-[1px]">
                                    <td class="flex items-center gap-1">
                                        <input class="w-full h-12 px-0 px-3 py-0 text-sm bg-blue-100 border-none" type="text"
                                            name="gajiDetailName{{ $counterRequest }}"
                                            value="{{ $loop->iteration }}. {{ $default->name }}">
                                        <div class="flex items-center gap-1 px-2">
                                            <p>(</p>
                                            <input id="Hadir{{ $counterHadir }}" name="gajiDetailQTY{{ $counterRequest }}"
                                                class="w-10 h-12 px-0 py-0 text-sm text-center bg-blue-100 border-none"
                                                type="text"
                                                value="{{ $totalmasuk - $absensiLemburTotal }}">
                                            <p>x</p>
                                            <input id="HadirValue{{ $counterHadir }}" name="gajiDetailValue{{ $counterRequest }}"
                                                class="h-12 px-0 py-0 text-sm text-center bg-blue-100 border-none w-28"
                                                type="text"
                                                value="{{ $default->value }}">
                                            <p>)</p>
                                        </div>
                                    ...
                                    <td class="border-[#242947] border-[1px] w-[50%]">
                                        <input id="totalHadir{{ $counterHadir }}" name="gajiDetailTotalValue{{ $counterRequest }}"
                                            class="w-full h-12 px-0 px-3 py-0 text-sm text-right bg-blue-100 border-none"
                                            type="text"
                            ...
                            @elseif ($default->status == 2)
                                <tr class="border-[#242947] border-[1px]">
                                    <td class="flex items-center gap-1">
                                        ...
                                        <div class="flex items-center gap-1 px-2">
                                            <p>(</p>
                                            <input id="disiplin{{ $counterDisiplin }}" name="gajiDetailQTY{{ $counterRequest }}"
                                                class="w-10 h-12 px-0 py-0 text-sm text-center bg-blue-100 border-none"
                                                type="text"
                                                value="{{ $totalmasuk - $totalTelat - $totalPulangCepat - $absensiLemburTotal }}">
                                            <p>x</p>
                                            <input id="disiplinValue{{ $counterDisiplin }}" name="gajiDetailValue{{ $counterRequest }}"
                                                class="h-12 px-0 py-0 text-sm text-center bg-blue-100 border-none w-28"
                                                type="text"
                                                value="{{ $default->value }}">
                                            <p>)</p>
                                    ...
                                    <td class="border-[#242947] border-[1px] w-[50%]">
                                        <input id="totalDisiplin{{ $counterDisiplin }}" name="gajiDetailTotalValue{{ $counterRequest }}"
                                            class="w-full h-12 px-0 px-3 py-0 text-sm text-right bg-blue-100 border-none"
                                            type="text"
                                    ...
                                    @php
                                        $totalHonor += ($totalmasuk - $totalTelat - $totalPulangCepat - $absensiLemburTotal) * $default->value;
                                        $counterDisiplin++;
                                        $counterRequest++;
                                    @endphp
                                </tr>
                            @elseif ($default->status == 3)
                                <tr class="border-[#242947] border-[1px]">
                                    <td class="flex items-center gap-1">
                                        ...
                                        <div class="flex items-center gap-1 px-2">
                                            <p>(</p>
                                            <input id="lembur{{ $counterLembur }}" name="gajiDetailQTY{{ $counterRequest }}"
                                                class="w-10 h-12 px-0 py-0 text-sm text-center bg-blue-100 border-none"
                                                type="text"
                                                value="{{ $absensiLemburTotal }}">
                                            <p>x</p>
                                            <input id="lemburValue{{ $counterLembur }}" name="gajiDetailValue{{ $counterRequest }}"
                                                class="h-12 px-0 py-0 text-sm text-center bg-blue-100 border-none w-28"
                                                type="text"
                                                value="{{ $default->value }}">
                                            <p>)</p>
                                    ...
                                    <td class="border-[#242947] border-[1px] w-[50%]">
                                        <input id="totalLembur{{ $counterLembur }}" name="gajiDetailTotalValue{{ $counterRequest }}"
                                            class="w-full h-12 px-0 px-3 py-0 text-sm text-right bg-blue-100 border-none"
                                            type="text"
                            ...
                            @elseif ($default->status == 4)
                                <tr class="border-[#242947] border-[1px]">
                                    <td class="flex items-center gap-1">
                                        ...
                                        <div class="flex items-center gap-1 px-2">
                                            <p>(</p>
                                            <input id="custom{{ $counterCustom }}" name="gajiDetailQTY{{ $counterRequest }}"
                                                class="w-10 h-12 px-0 py-0 text-sm text-center bg-blue-100 border-none"
                                                type="text"
                                                value="1" readonly>
                                            <p>x</p>
                                            <input id="customValue{{ $counterCustom }}" name="gajiDetailValue{{ $counterRequest }}"
                                                class="h-12 px-0 py-0 text-sm text-center bg-blue-100 border-none w-28"
                                                type="text"
                                                value="{{ $default->value }}">
                                            <p>)</p>
                                    ...
                                    <td class="border-[#242947] border-[1px] w-[50%]">
                                        <input id="totalcustom{{ $counterCustom }}" name="gajiDetailTotalValue{{ $counterRequest }}"
                                            class="w-full h-12 px-0 px-3 py-0 text-sm text-right bg-blue-100 border-none"
                                            type="text"
                        ...
                        <tr class="border-[#242947] border-[1px]">
                            <td class="">
                                <input class="w-full h-12 px-0 px-3 py-0 text-sm font-bold bg-blue-100 border-none" type="text" name="gajiDetailName{{ $counterRequest }}"
                                    value="Total Honor">
                            </td>
                            <td class="border-[#242947] border-[1px]">
                                <input id="TotalHonor" class="w-full h-12 px-0 px-3 py-0 text-sm text-right bg-blue-100 border-none" type="text" name="gajiDetailTotalValue{{ $counterRequest }}"
                                    value=" {{ Number::currency($totalHonor , 'IDR', locale: 'id_ID') }}" readonly>
                            </td>
                            @php
                                $counterRequest++;
                            @endphp
                ...
                <table class="w-full my-3 text-sm table-auto text-start">
                    <tbody class="w-full align-top border-t ">
                        ...
                        <tr>
                            ...
                            <td><textarea name="note" id="" rows="4" class="w-full" placeholder="Tambahkan Catatan...."></textarea></td>
                        </tr>
                        <tr>
                            <td></td>
                        </tr>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            buttonTambahKolom.addEventListener('click', function() {
                ...
                const newTd = `
                <td class=" border-[#242947] border-[1px]">
                    <input id="customHeader_${y}" class="w-full h-12 px-0 px-3 py-0 text-sm bg-blue-100 border-none" type="text" name="gajiHeaderName${y}"
                        placeholder="Nama" id="">
                </td>
                <td class="border-[#242947] border-[1px]">
                    <input class="w-full h-12 px-0 px-3 py-0 text-sm text-right bg-blue-100 border-none" type="text" name="gajiHeaderValue${y}"
            ...
            function updateTotal(custom, customValue, customTotal) {
                ...
                const formattedResultCustom = new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(resultCustom);
            ...
            buttonTambahKolom2.addEventListener('click', function() {
                ...
                newRow.innerHTML = `
                    <td class="flex items-center gap-1">
                        <input class="w-full h-12 px-0 px-3 py-0 text-sm bg-blue-100 border-none" type="text" name="gajiDetailName${counterRequest}"
                        placeholder='Masukkan Nama'>
                        <div class="flex items-center gap-1 px-2">
                            <p>(</p>
                            <input id="custom1_${x}" class="w-10 h-12 px-0 py-0 text-sm text-center bg-blue-100 border-none" type="text" name="gajiDetailQTY${counterRequest}"
                            placeholder='QTY'>
                            <p>x</p>
                            <input id="custom1Value_${x}" class="h-12 px-0 py-0 text-sm text-center bg-blue-100 border-none w-28" type="text" name="gajiDetailValue${counterRequest}"
                            placeholder='Nominal'>
                            <p>)</p>
                        </div>
                    </td>
                    <td class="border-[#242947] border-[1px] w-[50%]">
                        <input id="custom1total_${x}" class="w-full h-12 px-0 px-3 py-0 text-sm text-right bg-blue-100 border-none" type="text" name="gajiDetailTotalValue${counterRequest}"
            ...
            function updateTotalValue() {
                ...
                for (let i = 1; i < counterHadir; i++) {
                    ...
                    document.getElementById('totalHadir' + i).value = new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(resultHadir);
                ...
                for (let i = 1; i < counterDisiplin; i++) {
                    ...
                    document.getElementById('totalDisiplin' + i).value = new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(resultDisiplin);
                ...
                for (let i = 1; i < counterLembur; i++) {
                    ...
                    document.getElementById('totalLembur' + i).value = new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(resultLembur);
                ...
                for (let i = 1; i < counterCustom; i++) {
                    ...
                    document.getElementById('totalcustom' + i).value = new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(resultCustom);
                ...
                let formattedResultHonor = new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(totalHonor + totalCustomadd);
