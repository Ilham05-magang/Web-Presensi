                ...
                <div class=" flex flex-col gap-6 items-center justify-center w-full">
                    ...
                    <form action="/login" method="POST" class="flex flex-col gap-6 w-full px-5 md:px-0 max-w-xs">
                        ...
                        <div class="flex justify-center">
                            <button type="submit" class="bg-button px-3 py-2 text-white w-36 shadow-lg shadow-black/30 rounded-lg font-semibold hover:bg-[#ADB5BD] hover:border-button hover:border-[1px] border-[1px] border-button">Login</button>
                        </div>
                    </form>
